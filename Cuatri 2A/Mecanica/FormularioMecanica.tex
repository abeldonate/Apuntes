...
Forzados:
 \[
m \ddot{x} + kx = F_0\cos(\Omega t) \implies  x = A\cos(\Omega t),  A = \frac{F_0 / m}{\omega_0^2 -\Omega^2}
\] 
Si hay resonancia ($\Omega = \omega_0$):
\[
x = \frac{F_0/m}{2\omega_0}t\sin(\omega_0t)
\] 
Forzados y amortiguados:
 \[
m \ddot{x} + b\ddot{x} kx = F_0\cos(\Omega t) \implies x =  A\cos(\Omega t),  A = \frac{F_0 / m}{\omega_0^2 -\Omega^2}
\] 
