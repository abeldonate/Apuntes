...
Colineación $\centernot\implies$ Proyectividad \\
En $\P^1$  $f$ proyectividad  $\iff f$ conserva la razón doble. \\
$f:\P \to \P'$ biyectiva  $\dim\P \ge 1$. $f$ proyectividad  $\iff$  $\begin{cases}
  f \text{ colineación} \\
...
\\
\begin{itemize}
  \item \textbf{Homologías} de eje $H$ hiperplano es una homografía  $f$ que deja fijo  $H$ y tiene un único punto fijo $p_H$. Además toda recta por $p_H$ es invariante.
	 \begin{itemize}
