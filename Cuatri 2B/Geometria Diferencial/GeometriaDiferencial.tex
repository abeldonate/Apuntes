...
\hline
\textbf{Variedad} & \textbf{Parametrización} & \textbf{P} & \textbf{A} & \textbf{S}  \\
\hline
Revolución & $\begin{pmatrix} \varphi (u)\cos v \\ \varphi (u) \sin v \\ \psi (u) \end{pmatrix} $ & $\begin{pmatrix} 1 & 0 \\ 0 & \varphi^2 \end{pmatrix} $ & $\begin{pmatrix} \varphi ''\psi '-\varphi '\psi ''& 0 \\ 0 & -\frac{\psi '}{\varphi } \end{pmatrix} $ & $\begin{pmatrix} \varphi '\psi ''-\varphi ''\psi '& 0 \\ 0 & \varphi \psi ' \end{pmatrix} $
\end{tabular}
\end{center}
