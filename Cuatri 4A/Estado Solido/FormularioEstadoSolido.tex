...
\begin{align*}
  ...
  & N = \int_0^\infty d\varepsilon g(\varepsilon )n_F(\beta (\varepsilon -\mu )), \quad 
  E_T = \int_0^\infty d\varepsilon \varepsilon g(\varepsilon )n_F(\beta (\varepsilon -\mu ))\\
...
\begin{align*}
  ...
  &E^{\pm} = \frac{1}{2}(E^0_{\overline{k}-\overline{G}} + E^0_{\overline{k}})\pm \sqrt{\frac{1}{4}(E^0_{{\overline{k}}-\overline{G}}-E^0_{\overline{k}}) + |V_{\overline{G}}|^2} 
\end{align*}
